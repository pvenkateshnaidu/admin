    ...
    <div class="br-mainpanel">
      <div class="pd-30">
        <h4 class="tx-gray-800 mg-b-5">Faculty List</h4>
...
if(!empty($staffList)){
        ...
        <td><?= $staf->emp_name; ?></td>
                  ...
                  <td><?= $staf->email; ?></td>
                   <td><?=  $staf->emp_unique_id; 
                   ?></td>
                  
                  <td><?= $staf->emp_department_name; ?></td>
                     <td><?= $staf->emp_qualification; ?></td>
                  
               <td>
   <?php //echo anchor('Teacher/deleteTeacher/'.$staf->mid, 'Delete');
   ?></td>
                </tr>
			  <?php } }else{ ?>
